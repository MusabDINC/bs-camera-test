...
export default class Physics
{
    ...
    setCar()
    {
        ...
        this.car.options.controlsAcceleratinMaxSpeed = 0.055 * 3
        this.car.options.controlsAcceleratinMaxSpeedBoost = 0.11 * 3
        this.car.options.controlsAcceleratingSpeed = 2 * 4
        this.car.options.controlsAcceleratingSpeedBoost = 3.5 * 4
        ...
        this.time.on('tick', () =>
        {
            ...
            const accelerateStrength = accelerationSpeed * 2
            ...
            const engineForce = - this.car.accelerating * 10
            ...
            {
                this.car.vehicle.setBrake(this.car.options.controlsBrakeStrength * 3, 0)
                this.car.vehicle.setBrake(this.car.options.controlsBrakeStrength * 3, 1)
                this.car.vehicle.setBrake(this.car.options.controlsBrakeStrength * 3, 2)
                this.car.vehicle.setBrake(this.car.options.controlsBrakeStrength * 3, 3)
            }
            else
            {
                this.car.vehicle.setBrake(0, 0)
